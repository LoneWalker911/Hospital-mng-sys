        ...
        <table class="table table-striped">
          ...
          <tr>
            ...
            <ul id="myUL" style="list-style-type: none">
              <li><a class="form-control input-sm" href="#">Adele</a></li>
              <li><a class="form-control input-sm" href="#">Agnes</a></li>

              <li><a class="form-control input-sm" href="#">Billy</a></li>
              <li><a class="form-control input-sm" href="#">Bob</a></li>

              <li><a class="form-control input-sm" href="#">Calvin</a></li>
              <li><a class="form-control input-sm" href="#">Christina</a></li>
              <li><a class="form-control input-sm"href="#">Cindy</a></li>
            </ul></td>
          ...
          <tr>
            ...
            <td><input type="text" id="myInput" style="display:none" class="form-control input-sm" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">

            <ul id="myUL" style="display:none" style="list-style-type: none">
              <li><a class="form-control input-sm" href="#">Adele</a></li>
              <li><a class="form-control input-sm" href="#">Agnes</a></li>
