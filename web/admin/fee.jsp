...
<meta name="author" content="Creativeitem">
  ...
  <body>
    ...
    <tbody>
    <tr >
      <th scope="row">Hospital Fee</th>
      <td>1350</td>
      <td><input type="number" class="form-control input-sm" placeholder="Enter Here" name="NewHos" value=""></td>
      <td><button type="button" class="btn btn-primary" name="Hosbtn">Apply</button></td>
    </tr>
    <tr >
      <th scope="row">Appointment Fee</th>
      <td>1250</td>
      <td><input type="number" class="form-control input-sm" placeholder="Enter Here" name="NewApp" value=""></td>
      <td><button type="button" class="btn btn-primary" name="Appbtn">Apply</button></td>
    </tr>
    </tbody>
    </table>
    </div>
