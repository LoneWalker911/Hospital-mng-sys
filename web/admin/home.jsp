...
function fee()
{
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState === 4 && this.status === 200) {
        document.getElementById('test').innerHTML="<h3 style=\"margin:20px 0px; color:#818da1; font-weight:200;\"><i class=\"entypo-right-circled\"></i>Update fee</h3>"+this.responseText;
    }
  };
  xmlhttp.open("GET", "http://localhost:8080/Hospital-mng-sys/admin/fee.jsp", true);
  xmlhttp.send();
