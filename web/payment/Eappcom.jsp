...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="text">
      <p2 style="">Your e-Appointment has placed successfully.</p2><br>
      <label for="pid">Your ID :</label>
      <label id="Pid"><%out.print(info.get("pid"));%></label><br>
      <label for="address">eAppointment ID :</label>
      <label id="Appid"><%out.print(info.get("appid"));%></label><br>
      <label for="address">Date and Time :</label>
      <label id="time"><%out.print(info.get("time"));%></label>
    </div>
    <div class="images">
