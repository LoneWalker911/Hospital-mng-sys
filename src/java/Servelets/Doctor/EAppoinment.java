 ...
 * @author thisa
 */
public class EAppoinment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(login.getUser_type_id()!=5 && login.getUser_type_id()!=6) //change this after development is complete
                ...
                HashMap<Integer, String[]> info = app.getdApps();
                request.setAttribute("info", info);
                RequestDispatcher view = request.getRequestDispatcher("/doctor/EAppoinment.jsp");
